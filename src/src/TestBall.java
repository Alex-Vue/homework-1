...
public class TestBall extends LockedTestCase{
	...
	private void testColliding(boolean ignored) {
		b1 = new Ball(new Point(100,100), new Vector(7,3), Color.BLUE); //rad = 15
		b2 = new Ball(new Point(60,100), new Vector(8,-4), Color.RED); // rad = 15
		assertEquals(Tb(1558120703),b1.isColliding(b2));
		b1.setRadius(25);
		assertEquals(Tb(418725074),b1.isColliding(b2));
		b2.setRadius(10);
		assertEquals(Tb(1200559635),b1.isColliding(b2));
		b1.setRadius(50);
		assertEquals(Tb(1747159676),b1.isColliding(b2));
		testBounceWalls(true);
	}
	
	private void testBounceWalls(boolean ignored) {
		b1 = new Ball(new Point(100,100), new Vector(7,3), Color.BLUE); //rad = 15
		b1.bounceWalls(new Dimension(110,110));
		assertEquals(Td(548002987),b1.getMove().dx());
