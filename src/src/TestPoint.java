...
public class TestPoint extends LockedTestCase {
	...
	public void test() {
		...
		Point ppp = new Point(-1.3,1.6000000001); // within precision of doubles
		assertEquals(Tb(2020914432),p.equals(ppp));
		Point p4 = new Point(-1.3,1.600000000000000000000000001); // not within!
		assertEquals(true,p.equals(p4));
		testcont(42);
	}
